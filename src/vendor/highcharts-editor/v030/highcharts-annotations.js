 ...
 */ !(function (t) {
  "object" == typeof module && module.exports
    ...
    ? define("highcharts/modules/annotations", ["highcharts"], function (i) {
  ...
  s(
    ...
    function (t, i) {
      ...
      function g(t) {
        ...
        s &&
          (r(s, "remove"),
          n(this.options.annotations, s.options),
          n(i, s),
          s.destroy());
      }
      function m() {
      ...
      function (t, i) {
        ...
        return class {
              ...
              a(t.options.events, (i, s) => {
                let e = function (e) {
                  ("click" === s && t.cancelClick) ||
                    i.call(t, t.chart.pointer.normalize(e), t.target);
                };
                -1 === (t.nonDOMEvents || []).indexOf(s)
                  ? (o(t.graphic.element, s, e, { passive: !1 }),
                    t.graphic.div && o(t.graphic.div, s, e, { passive: !1 }))
                  : o(t, s, e, { passive: !1 });
              }),
              t.options.draggable &&
                (o(t, "drag", t.onDrag), !t.graphic.renderer.styledMode))
            ) {
              let i = {
          ...
          mouseMoveToRadians(t, i, s) {
            ...
            return (
              this.chart.inverted &&
                ((r = o), (o = e), (e = r), (r = a), (a = n), (n = r)),
              Math.atan2(n, a) - Math.atan2(e, o)
            );
          }
          ...
          mouseMoveToTranslation(t) {
            let i = t.chartX - t.prevChartX,
              ...
              e;
            return (
              this.chart.inverted && ((e = s), (s = i), (i = e)), { x: i, y: s }
            );
          }
          onDrag(t) {
            if (
          ...
          onMouseDown(t) {
            ...
            (i.cancelClick = !1),
              ...
              (i.removeDrag = o(
                ...
                e || l ? { passive: !1 } : void 0
              )),
              (i.removeMouseUp = o(
                s,
                e || l ? "touchend" : "mouseup",
                function (t) {
                  let s = r(i.target && i.target.annotation, i.target);
          ...
          onMouseUp(t) {
            let i = this.chart,
              s = this.target || this,
              e = i.options.annotations,
              o = i.annotations.indexOf(s);
            this.removeDocEvents(), (e[o] = s.options);
          }
          removeDocEvents() {
    ...
    s(
      ...
      [i["Extensions/Annotations/EventEmitter.js"], i["Core/Utilities.js"]],
      function (t, i) {
        let { merge: s, pick: e } = i;
      ...
      function (t, i) {
        ...
        class n {
          ...
          static pointToPixels(t, i) {
            ...
            return (
              e.inverted &&
                (t.mock
                  ? ((o = t.plotY), (n = t.plotX))
                  : ((o = e.plotWidth - (t.plotY || 0)),
                    (n = e.plotHeight - (t.plotX || 0)))),
              s &&
                !i &&
                ((o += (a = s.getPlotBox()).translateX), (n += a.translateY)),
              { x: o, y: n }
            );
          }
          ...
          isInsidePlot() {
            ...
            return (
              s && (a.isInsidePlot = e(t) && t >= 0 && t <= s.len),
              n &&
                (a.isInsidePlot =
                  a.isInsidePlot && e(i) && i >= 0 && i <= n.len),
              o(this.series.chart, "afterIsInsidePlot", a),
              a.isInsidePlot
            );
          }
          refresh() {
            let t = this.series,
              ...
              e = this.getOptions();
            i
              ? ((this.x = e.x), (this.plotX = i.toPixels(e.x, !0)))
              : ((this.x = void 0), (this.plotX = e.x)),
              s
                ? ((this.y = e.y), (this.plotY = s.toPixels(e.y, !0)))
                : ((this.y = null), (this.plotY = e.y)),
          ...
          rotate(t, i, s) {
            if (!this.hasDynamicOptions()) {
              let e = Math.cos(s),
                ...
                n = this.plotX - t,
                a = this.plotY - i;
              (this.plotX = n * e - a * o + t),
                (this.plotY = n * o + a * e + i),
                this.refreshOptions();
            }
          }
          scale(t, i, s, e) {
          ...
          setAxis(t, i) {
            let s = i + "Axis",
              ...
              n = this.series.chart;
            this.series[s] =
              "object" == typeof o ? o : e(o) ? n[s][o] || n.get(o) : null;
          }
          toAnchor() {
          ...
          translate(t, i, s, e) {
            this.hasDynamicOptions() ||
              ((this.plotX += s), (this.plotY += e), this.refreshOptions());
          }
        }
        return n;
      }
        ...
        return (
          (function (e) {
            ...
            function d(t, i, s, e, o) {
              ...
              this.points.forEach(
                (n, a) => this.transformPoint(t, i, s, e, o, a),
                this
              );
            }
    ...
    s(
      ...
      [i["Extensions/Annotations/ControlTarget.js"], i["Core/Utilities.js"]],
      function (t, i) {
        let { merge: s } = i;
        class e {
          constructor(t, i, s, e) {
            (this.annotation = t),
              (this.chart = t.chart),
              (this.collection = "label" === e ? "labels" : "shapes"),
              (this.controlPoints = []),
              (this.options = i),
              (this.points = []),
              (this.index = s),
          ...
          attrsFromOptions(t) {
            ...
            for (i in t)
              (s = e[i]),
                void 0 === e[i] ||
                  (n && -1 !== ["fill", "stroke", "stroke-width"].indexOf(s)) ||
                  (o[s] = t[i]);
            return o;
          }
          destroy() {
          ...
          update(t) {
            let i = this.annotation,
              ...
              n = this.constructor;
            this.destroy();
            let a = new n(i, e, this.index, this.itemType);
            s(!0, this, a), this.render(o), this.redraw();
          }
        }
    ...
    s(
      ...
      [
        ...
        i["Extensions/Annotations/Controllables/ControllableDefaults.js"],
        i["Core/Globals.js"],
        i["Core/Utilities.js"],
      ],
      function (t, i, s, e) {
        let { defaultMarkers: o } = i,
          { composed: n } = s,
          {
            addEvent: a,
            defined: r,
          ...
          d = m("marker-end"),
          u = m("marker-start"),
          g = "rgba(192,192,192," + (s.svg ? 1e-4 : 0.002) + ")";
        function m(t) {
          return function (i) {
            this.attr(t, "url(#" + i + ")");
          };
        ...
        function f() {
          this.options.defs = h(o, this.options.defs || {});
        }
        function x(t, i) {
        ...
        class b extends t {
          static compose(t, i) {
            if (c(n, this.compose)) {
              let s = i.prototype;
              a(t, "afterGetContainer", f), (s.addMarker = x);
            }
          }
          constructor(t, i, s) {
          ...
          toD() {
            ...
            return o && this.graphic
              ? this.chart.renderer.crispLine(e, this.graphic.strokeWidth())
              : null;
          }
          shouldBeDrawn() {
          ...
          render(t) {
            ...
            (this.graphic = this.annotation.chart.renderer
              ...
              super.render(),
              l(this.graphic, { markerStartSetter: u, markerEndSetter: d }),
          ...
          redraw(t) {
            if (this.graphic) {
              let i = this.toD(),
                s = t ? "animate" : "attr";
              i
                ? (this.graphic[s]({ d: i }), this.tracker[s]({ d: i }))
          ...
          setMarkers(t) {
            ...
            ["markerStart", "markerEnd"].forEach(function (o) {
              ...
              if (a) {
                for (c in e)
                  if (
                    (a === ((r = e[c]).attributes && r.attributes.id) ||
                      a === r.id) &&
                    "marker" === r.tagName
                  ) {
                    l = r;
    ...
    s(
      ...
      function (t, i, s) {
        ...
        return (
          (o.attrsMap = e(i.attrsMap, { width: "width", height: "height" })), o
        );
      }
    ),
    s(
      ...
      function (t, i, s) {
        ...
        return (o.attrsMap = e(i.attrsMap, { r: "r" })), o;
      }
    ),
    s(
      i,
      ...
      function (t, i, s) {
        ...
        class n extends t {
          ...
          getDistanceFromLine(t, i, s, e) {
            return (
              Math.abs(
                (i.y - t.y) * s - (i.x - t.x) * e + i.x * t.y - i.y * t.x
              ) /
        ...
        return (n.attrsMap = e(i.attrsMap, { ry: "ry" })), n;
      }
    ),
    s(
      i,
      ...
      function (t, i, s, e, o) {
        let { format: n } = i,
          { composed: a } = s,
          { extend: r, isNumber: l, pick: h, pushUnique: c } = o;
        function p(t, i, s, e, o) {
          let n = o && o.anchorX,
            a = o && o.anchorY,
            r,
            h,
        ...
        class d extends t {
          static alignedPosition(t, i) {
            ...
            return (
              ...
              "bottom" === e ? (r = 1) : "middle" === e && (r = 2),
              r && (n += (i.height - (t.height || 0)) / r),
              { x: Math.round(o), y: Math.round(n) }
            );
          }
          static compose(t) {
            if (c(a, this.compose)) {
              let i = t.prototype;
              i.symbols.connector = p;
            }
          }
          static justifiedOptions(t, i, s, e) {
            ...
            return (
              (o = c + r) < 0 &&
                ("right" === n ? (h.align = "left") : (h.x = (h.x || 0) - o)),
              (o = c + l.width - r) > t.plotWidth &&
                ("left" === n
                  ? (h.align = "right")
                  : (h.x = (h.x || 0) + t.plotWidth - o)),
              (o = p + r) < 0 &&
                ("bottom" === a
                  ? (h.verticalAlign = "top")
                  : (h.y = (h.y || 0) - o)),
              (o = p + l.height - r) > t.plotHeight &&
                ("top" === a
                  ? (h.verticalAlign = "bottom")
                  : (h.y = (h.y || 0) + t.plotHeight - o)),
              h
            );
          }
          constructor(t, i, s) {
              ...
              this.annotation.chart.styledMode ||
                ("contrast" === e.color &&
                  (e.color = this.annotation.chart.renderer.getContrast(
                    d.shapesWithoutBackground.indexOf(i.shape) > -1
                      ? "#FFFFFF"
                      : i.backgroundColor
                  )),
          ...
          redraw(t) {
            ...
            e.attr({
              text: s
                ? n(String(s), o.getLabelConfig(), this.annotation.chart)
          ...
          anchor(t) {
            ...
            return (
              ...
              (i.absolutePosition.y -= e),
              (i.relativePosition.x -= s),
              (i.relativePosition.y -= e),
              i
            );
          }
          position(t) {
            let i = this.graphic,
              ...
              c = t.relativePosition,
              p,
              u,
              g,
              m,
              f = n.series.visible && e.prototype.isInsidePlot.call(n);
            if (i && f) {
              let { width: t = 0, height: e = 0 } = i;
              a.distance && o
                ? (p = o.getPosition.call(
                    {
                      chart: s,
                ...
                : a.positioner
                ? (p = a.positioner.call(this))
                : ((u = { x: l.x, y: l.y, width: 0, height: 0 }),
                  (p = d.alignedPosition(r(a, { width: t, height: e }), u)),
                  "justify" === this.options.overflow &&
                    (p = d.alignedPosition(d.justifiedOptions(s, i, a, p), u))),
                a.crop &&
                  ((g = p.x - s.plotLeft),
                  (m = p.y - s.plotTop),
                  (f = s.isInsidePlot(g, m) && s.isInsidePlot(g + t, m + e)));
            }
            return f ? p : null;
          }
        }
    ...
    s(
      ...
      function (t, i) {
        ...
        return (
          (s.attrsMap = { width: "width", height: "height", zIndex: "zIndex" }),
          s
        );
      }
    ),
    ...
    s(
      ...
      [i["Core/Utilities.js"]],
      function (t) {
        let { defined: i, isNumber: s, pick: e } = t,
          o = {
        ...
        return {
          ...
          getFieldType: function (t, s) {
            ...
            return (
              i(e) && (n = e),
              { string: "text", number: "number", boolean: "checkbox" }[n]
            );
          },
        };
      }
                  ...
                  if (e && n)
                    return this.chart.addAnnotation(
                      o(
                        ...
                        a.bindings.circleAnnotation.annotationsOptions
                      )
                    );
                },
                steps: [
                  function (t, i) {
                    ...
                    if (e(n.xAxis) && e(n.yAxis)) {
                      ...
                      s = Math.max(
                        Math.sqrt(
                          Math.pow(i ? o - t.chartX : e - t.chartX, 2) +
                            Math.pow(i ? e - t.chartY : o - t.chartY, 2)
                        ),
                        5
                      );
                    }
                  ...
                  if (e && n)
                    return this.chart.addAnnotation(
                      o(
                        ...
                        a.annotationsOptions,
                        a.bindings.ellipseAnnotation.annotationOptions
                      )
                    );
                },
                steps: [
                  function (t, i) {
                    ...
                    s.translatePoint(t.chartX - e.x, t.chartY - e.y, 1),
                      s.redraw(!1);
                  },
                  function (t, i) {
                    let s = i.shapes[0],
                  ...
                  if (e && n)
                    return this.chart.addAnnotation(
                      o(
                        ...
                        a.annotationsOptions,
                        a.bindings.labelAnnotation.annotationsOptions
                      )
                    );
                },
              },
    ...
    s(
      ...
      function (t, i, s, e, o, n, a) {
        let { setOptions: r } = i,
          { format: l } = s,
          { composed: h, doc: c, win: p } = e,
          { getFieldType: d } = n,
          {
            addEvent: u,
            attr: g,
        ...
        function j() {
          ...
          t &&
            ...
            ((this.navigationBindings = new T(this, t.navigation)),
                  ...
                  f(s, "showPopup", {
                    ...
                    onSubmit: function (t) {
                      if ("remove" === t.actionType)
                        (s.activeAnnotation = !1), s.chart.removeAnnotation(i);
                      else {
                        let e = {};
        ...
        class T {
          ...
          initEvents() {
            ...
            (t.boundClassNames = {}),
                ...
                t.eventsToUnbind.push(
                  u(i, "click", (s) => {
                    ...
                    e &&
                      ...
                      t.bindingsButtonClick(e.button, e.events, s);
                  })
                );
              }),
              C(o.events || {}, (i, s) => {
                b(i) && t.eventsToUnbind.push(u(t, s, i, { passive: !1 }));
              }),
              t.eventsToUnbind.push(
              ...
              t.eventsToUnbind.push(
                u(
                  i.container,
                  e.isTouchDevice ? "touchmove" : "mousemove",
                  function (i) {
                    t.bindingsContainerMouseMove(this, i);
                  },
                  e.isTouchDevice ? { passive: !1 } : void 0
                )
              );
          }
          initUpdate() {
          ...
          bindingsButtonClick(t, i, s) {
            ...
            this.selectedButtonElement &&
              ...
              f(this, "deselectButton", { button: this.selectedButtonElement }),
              this.nextEvent &&
              ...
              n
                ? ((this.selectedButton = i),
                  ...
                  f(this, "selectButton", { button: t }),
                  i.init && i.init.call(this, t, s),
                  (i.start || i.steps) &&
                    e.renderer.boxWrapper.addClass("highcharts-draw-mode"))
                : (e.stockTools && e.stockTools.toggleButtonActiveClass(t),
                    ...
                    this.steps &&
                      ...
                      e.steps[this.stepIndex]
                        ? (this.mouseMoveEvent = this.nextEvent =
                            e.steps[this.stepIndex])
                        : (f(this, "deselectButton", {
                            button: this.selectedButtonElement,
                          }),
                          o.removeClass("highcharts-draw-mode"),
                          e.end && e.end.call(this, i, this.currentUserDetails),
                          (this.nextEvent = !1),
                          (this.mouseMoveEvent = !1),
                          (this.selectedButton = null))))
                  : ((this.currentUserDetails = e.start.call(this, i)),
                    this.currentUserDetails && e.steps
                      ? ((this.stepIndex = 0),
                        (this.steps = !0),
                        (this.mouseMoveEvent = this.nextEvent =
                          e.steps[this.stepIndex]))
                      : (f(this, "deselectButton", {
                        ...
                        (this.selectedButton = null),
                        e.end &&
                          e.end.call(this, i, this.currentUserDetails))));
          }
            ...
            return (
              C(t, (t, s) => {
                let e = parseFloat(t),
                  ...
                  n = o.length - 1;
                if (
                  (!v(e) || t.match(/px|em/g) || s.match(/format/g) || (t = e),
                  "undefined" !== t)
                ) {
                  let s = i;
                  o.forEach((i, e) => {
          ...
          annotationToFields(t) {
            let i = t.options,
              ...
              n = T.annotationsNonEditable[i.langKey] || [],
            ...
            function r(i, s, o, a, h) {
              ...
              o &&
                m(i) &&
                -1 === n.indexOf(s) &&
                ((o.indexOf && o.indexOf(s)) >= 0 || o[s] || !0 === o) &&
                (x(i)
                  ? ((a[s] = []),
                    i.forEach((t, i) => {
                      y(t)
                  ...
                  : y(i)
                  ? ((c = {}),
                    x(a) ? (a.push(c), (c[s] = {}), (c = c[s])) : (a[s] = c),
                    C(i, (t, i) => {
                      r(t, i, 0 === s ? o : e[s], c, s);
                    }))
                  : "format" === s
                  ? (a[s] = [l(i, t.labels[0].points[0]).toString(), "text"])
                  : x(a)
                  ? a.push([i, d(h, i)])
                  : (a[s] = [i, d(s, i)]));
            }
          ...
          getButtonEvents(t, i) {
            let s;
            let e = this,
              o = this.getClickedClassNames(t, i);
            return (
              o.forEach((t) => {
                e.boundClassNames[t[0]] &&
                  !s &&
                  (s = { events: e.boundClassNames[t[0]], button: t[1] });
              }),
              s
            );
          }
          update(t) {
            (this.options = A(!0, this.options, t)),
              this.removeEvents(),
              this.initEvents();
          }
          removeEvents() {
    ...
    s(
      ...
      function (t, i) {
        let { addEvent: s, createElement: e } = i;
        return class {
          constructor(t, i) {
            (this.iconsURL = i),
          ...
          createPopupContainer(
            ...
            return e("div", { className: i }, void 0, t);
          }
          addCloseButton(t = "highcharts-popup-close") {
            let i = this,
              o = this.iconsURL,
              n = e("div", { className: t }, void 0, this.container);
            return (
              (n.style["background-image"] =
                "url(" +
                (o.match(/png|svg|jpeg|jpg|gif/gi) ? o : o + "close.svg") +
                ")"),
          ...
          showPopup(i = "highcharts-annotation-toolbar") {
            ...
            (this.type = void 0),
              ...
              s.className.indexOf(i) >= 0 &&
                (s.classList.remove(i), s.removeAttribute("style")),
              s.appendChild(e),
      ...
      function (t, i) {
        ...
        function c(t, i, l, p, d, u) {
          ...
          r(p, (s, e) => {
            (g = "" !== l ? l + "." + e : e),
              a(s) &&
                (!n(s) || (n(s) && a(s[0]))
                  ? ((m = x[e] || e).match(/\d/g) || d.push([!0, m, t]),
                    c.call(this, t, i, g, s, d, !1))
                  : d.push([this, g, "annotation", t, s]));
          }),
            u &&
        ...
        return {
          addForm: function (t, i, e, n) {
            ...
            l.appendChild(s.createTextNode(r[i.langKey] || i.langKey || "")),
              (l = o(
                "div",
                {
                  className:
            ...
            c.call(this, l, t, "", i, [], !0),
              this.addButton(
                h,
                n ? r.addButton || "Add" : r.saveButton || "Save",
                n ? "add" : "save",
                a,
                e
              );
          ...
          addToolbar: function (t, i, e) {
            ...
            -1 === a.className.indexOf(h) &&
              (a.className += " " + h + " highcharts-no-mousewheel"),
              t && (a.style.top = t.plotTop + 10 + "px"),
              o("span", void 0, void 0, a).appendChild(
                s.createTextNode(
                  l(n[i.langKey] || i.langKey, i.shapes && i.shapes[0].type, "")
                )
              );
            let c = this.addButton(
              a,
              n.removeButton || "Remove",
              "remove",
              a,
              e
            );
            (c.className += " highcharts-annotation-remove-button"),
              (c.style["background-image"] =
                "url(" + this.iconsURL + "destroy.svg)"),
              (c = this.addButton(a, n.editButton || "Edit", "edit", a, () => {
                r.call(this, "annotation-edit", t, i, e);
              })),
              (c.className += " highcharts-annotation-edit-button"),
              (c.style["background-image"] =
    ...
    s(
      ...
      function (t, i, s, e, o) {
        ...
        ((a = n || (n = {}))[(a["params.algorithm"] = 0)] = "params.algorithm"),
        ...
        function b(t) {
          let i = p(
            ...
            s = p("div", { className: "highcharts-popup-rhs-col" }, void 0, t);
          return (
            p(
              "div",
        ...
        function v(i, s, e, o) {
          ...
          (o.innerHTML = t.emptyHTML),
            p(
              "h3",
              { className: "highcharts-indicator-title" },
              void 0,
              o
            ).appendChild(r.createTextNode(j(s, e).indicatorFullName)),
            p(
              "input",
            ...
            n.volumeSeriesID &&
              B.call(
                ...
                o,
                s,
                s.linkedParent && n.volumeSeriesID
              ),
            A.call(this, i, "params", n, e, o);
        }
        function y(i, s, e, o) {
          let n = this,
            a = n.lang,
            ...
            d = "edit" === e,
            g = d ? i.series : i.options.plotOptions || {};
          if (!i && g) return;
          let m,
            x = [];
          d || u(g) ? u(g) && (x = w.call(this, g)) : (x = k.call(this, g, o)),
            f(x, (t, i) => {
          ...
          let b = p(
            ...
            y = h.querySelectorAll(".highcharts-popup-rhs-col-wrapper")[0];
          x.forEach((t) => {
            let { indicatorFullName: s, indicatorType: e, series: o } = t;
            (m = p(
              "li",
              { className: "highcharts-indicator-list" },
              void 0,
                  ...
                  v.call(n, i, o, e, y),
                    ...
                    d &&
                      ...
                      p(
                        ...
                        void 0,
                        y
                      ).setAttribute("highcharts-data-series-id", o.options.id);
                });
              });
          }),
        ...
        function A(t, i, s, e, o) {
          ...
          m(s, (s, r) => {
            ...
            if (d(s) && h) {
              if (
                (g(s) &&
                  (a.call(this, h, e, o, {}), A.call(this, t, h, s, e, o)),
                h in n)
              ) {
                let n = E.call(this, e, h, o);
                P.call(this, t, i, n, e, r, s);
              } else
                "params.volumeSeriesID" === h ||
                  u(s) ||
                  a.call(this, h, e, o, { value: s, type: "number" });
            }
          });
        }
        function C(t, i) {
          let s = this,
            ...
            n = p("div", { className: "highcharts-input-wrapper" }, void 0, e),
            a = function (i) {
              y.call(s, t, s.container, "add", i);
            },
          ...
          r.classList.add("highcharts-input-search-indicators"),
            ...
            ["click", "touchstart"].forEach((t) => {
              c(l, t, function () {
                (r.value = ""), a(""), (l.style.display = "none");
              });
            });
        }
        function E(t, i, s) {
          let e = i.split("."),
            ...
            a = this.lang;
          p("label", { htmlFor: n }, null, s).appendChild(
            r.createTextNode(a[o] || i)
          );
          let l = p(
            "select",
            {
        ...
        function P(t, i, s, e, o, n, a) {
          if ("series" === i || "volume" === i)
            t.series.forEach((t) => {
              let e = t.options,
                o = e.name || e.params ? t.name : e.id || "";
              "highcharts-navigator-series" !== e.id &&
                e.id !== (a && a.options && a.options.id) &&
                (d(n) || "volume" !== i || "column" !== t.type || (n = e.id),
                p("option", { value: e.id }, void 0, s).appendChild(
                  r.createTextNode(o)
                ));
            });
          else if (e && o) {
            let t = x[o + "-" + e];
            t.forEach((t) => {
              p("option", { value: t }, void 0, s).appendChild(
                r.createTextNode(t)
              );
            });
          }
        ...
        function k(t, i) {
          ...
          let e = this.chart && this.chart.options.lang,
            o =
              ...
              e.navigation &&
              e.navigation.popup &&
              e.navigation.popup.indicatorAliases,
            n = [];
          return (
            m(t, (t, e) => {
              let a = t && t.options;
              if (t.params || (a && a.params)) {
                let { indicatorFullName: a, indicatorType: r } = j(t, e);
                if (i) {
                  let e = i.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"),
                    l = RegExp(e, "i"),
                    h = (o && o[r] && o[r].join(" ")) || "";
                  ...
                  (s = { indicatorFullName: a, indicatorType: r, series: t }),
                    n.push(s);
              }
            }),
            n
        ...
        function j(t, i) {
          let s = t.options,
            e = (h[i] && h[i].prototype.nameBase) || i.toUpperCase(),
            o = i;
          return (
            s && s.type && ((o = t.options.type), (e = t.name)),
            { indicatorFullName: e, indicatorType: o }
          );
        }
        function B(t, i, s, e, o, n) {
          if ((this.indicators, !s)) return;
          let a = E.call(this, t, i, e);
          P.call(this, s, i, a, void 0, void 0, void 0, o),
            d(n) && (a.value = n);
        }
        return {
          addForm: function (t, i, s) {
            ...
            b(n[0]),
              C.call(this, t, n[0]),
              y.call(this, t, n[0], "add"),
              (e = n[0].querySelectorAll(".highcharts-popup-rhs-col")[0]),
              this.addButton(e, o.addButton || "add", "add", e, s),
              b(n[1]),
              y.call(this, t, n[1], "edit"),
              (e = n[1].querySelectorAll(".highcharts-popup-rhs-col")[0]),
              this.addButton(e, o.saveButton || "save", "edit", e, s),
              this.addButton(e, o.removeButton || "remove", "remove", e, s);
          },
          getAmount: function () {
            let t = 0;
            return (
    ...
    s(
      ...
      function (t, i) {
        ...
        function a(t, i) {
          ...
          let r = o("span", { className: a }, void 0, e);
          return (
            r.appendChild(s.createTextNode(n[t + "Button"] || t)),
        ...
        function h(t) {
          let i = this,
            s = this.container,
            o = s.querySelectorAll(".highcharts-tab-item");
          o.forEach((s, o) => {
            (0 !== t ||
              "edit" !== s.getAttribute("highcharts-data-tab-type")) &&
              ["click", "touchstart"].forEach((t) => {
                e(s, t, function () {
      ...
      function (t, i, s, e, o, n, a) {
        ...
        class g extends t {
          constructor(t, i, s) {
            super(t, i),
              (this.chart = s),
              (this.lang = (l().lang.navigation || {}).popup || {}),
          ...
          addInput(t, i, s, e) {
            ...
            n.match(/^\d+$/) ||
              c(
                "label",
                { htmlFor: l, className: e.labelClassName },
                void 0,
                s
              ).appendChild(r.createTextNode(a[n] || n));
            let h = c(
              "input",
              {
                name: l,
            ...
            if (this.chart) {
              ...
              d(t, "closePopup"),
                t &&
                  ...
                  d(t, "deselectButton", { button: t.selectedButtonElement });
            } else super.closeButtonEvents();
          }
          addButton(t, i, s, e, o) {
            let n = c("button", void 0, void 0, t);
            return (
              n.appendChild(r.createTextNode(i)),
              o &&
                ["click", "touchstart"].forEach((t) => {
                  h(
                    n,
                    ...
                    () => (
                      ...
                      o(
                        (function (t, i) {
                          let s = Array.prototype.slice.call(
                          ...
                          return (
                            s.forEach((t) => {
                              let i = t.getAttribute("highcharts-data-name"),
                                s = t.getAttribute("highcharts-data-series-id");
                              s
                                ? (a.seriesId = t.value)
                                : i
                                ? (a.fields[i] = t.value)
          ...
          showForm(t, i, s, e) {
            i &&
              (this.showPopup(),
              "indicators" === t && this.indicators.addForm.call(this, i, s, e),
              "annotation-toolbar" === t &&
                this.annotations.addToolbar.call(this, i, s, e),
              "annotation-edit" === t &&
                this.annotations.addForm.call(this, i, s, e),
              "flag" === t && this.annotations.addForm.call(this, i, s, e, !0),
              (this.type = t),
    ...
    s(
      ...
      function (t, i, s) {
        let { composed: e } = t,
          { addEvent: o, pushUnique: n, wrap: a } = s;
        function r() {
    ...
    s(
      ...
      [
        ...
        i["Extensions/Annotations/Controllables/ControllableEllipse.js"],
        i["Extensions/Annotations/Controllables/ControllablePath.js"],
      ...
      function (t, i, s, e, o, n, a, r, l, h, c, p, d, u, g, m) {
        let { getDeferredAnimation: f } = t,
          {
        ...
        class P extends p {
          ...
          constructor(t, i) {
            super(),
              ...
              (this.labels = []),
              (this.shapes = []),
              (this.options = y(this.defaultOptions, i)),
              (this.userOptions = i);
            let s = E(this.options, i);
          ...
          destroy() {
            ...
            this.labels.forEach(i),
              ...
              (this.clipXAxis = null),
              (this.clipYAxis = null),
              b(t.labelCollectors, this.labelCollector),
              super.destroy(),
              this.destroyControlTarget(),
              x(this, t);
          }
          ...
          initShape(t, i) {
            let s = y(
              ...
              e = new P.shapesMap[s.type](this, s, i);
            ...
            t.linkPoints(),
              t.shouldBeDrawn()
                ? (t.graphic || this.renderItem(t),
                  t.redraw(A(i, !0) && t.graphic.placed),
                  t.points.length &&
                    (function (t) {
                      let i = t.graphic,
                        s = t.points.some(
                      ...
                      i &&
                        (s ? "hidden" === i.visibility && i.show() : i.hide());
                    })(t))
                : this.destroyItem(t);
          }
          redrawItems(t, i) {
          ...
          setOptions(t) {
            this.options = y(this.defaultOptions, t);
          }
          setVisibility(t) {
            let i = this.options,
              ...
              e = A(t, !i.visible);
            if (
              (this.graphic.attr("visibility", e ? "inherit" : "hidden"), !e)
            ) {
              let t = function (t) {
          ...
          update(t, i) {
            let s = this.chart,
              e = E(this.userOptions, t),
              o = s.annotations.indexOf(this),
              n = y(!0, this.userOptions, t);
            (n.labels = e.labels),
              (n.shapes = e.shapes),
              this.destroy(),
              this.initProperties(s, n),
              this.init(s, n),
              (s.options.annotations[o] = n),
              (this.isUpdating = !0),
              A(i, !0) && s.drawAnnotations(),
              v(this, "afterUpdate"),
              (this.isUpdating = !1);
          }
        }
        return (
          (P.ControlPoint = h),
          (P.MockPoint = d),
          (P.shapesMap = { rect: e, circle: o, ellipse: n, path: a, image: r }),
          (P.types = {}),
          (P.prototype.defaultOptions = s),
          (P.prototype.nonDOMEvents = ["add", "afterUpdate", "drag", "remove"]),
          c.compose(P),
          P
        );
      }
